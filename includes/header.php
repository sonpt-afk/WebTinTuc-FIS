		...
		<nav class="navbar navbar-default" role="navigation">
		  	<div class="container-fluid">
		    	<div class="navbar-header">
		      		...
		      		<a class="navbar-brand" href="<?php echo $_DOMAIN; ?>"> 	Tổ dân phố Trung Hòa</a>
					<br>
					<br>
					<br>
<p>Bạn là quản trị viên /thành viên tổ dân phố ?</p>
					  <a class="navbar-account" href="<?php echo $_DOMAIN. "admin"; ?>"> Đăng nhập </a>
		    	</div>
